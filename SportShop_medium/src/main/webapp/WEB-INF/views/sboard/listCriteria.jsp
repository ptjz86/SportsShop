						...
						<c:forEach items="${list}" var="boardVO">
							<tr>
								...
								<td><a class="titleClick"
									href="/sboard/bread${pageMaker.makeSearch(pageMaker.cri.page)}&bno=${boardVO.bno}&orderType=${pageMaker.cri.orderType}">${boardVO.title}<strong>[${boardVO.replyCnt}]</strong></a></td>
			...
			<div class="row">
				<div class="text-center">
					<ul class="pagination pagination-lg">
						...
						<li><a href="blistCriteria${pageMaker.makeSearch(1)}&orderType=${pageMaker.cri.orderType}">
											<span aria-hidden="true">First</span>
									</a></li>
						<li><a
							href="blistCriteria${pageMaker.makeSearch(pageMaker.cri.page-1)}&orderType=${pageMaker.cri.orderType}">&laquo;</a></li>
						...
						<li
							...
							<c:out value="${pageMaker.cri.page==idx?'class=active' : ''}" />><a
							href="blistCriteria?page=${idx}&perPageNum=${pageMaker.cri.perPageNum}&searchType=${pageMaker.cri.searchType}&keyword=${pageMaker.cri.keyword}&orderType=${pageMaker.cri.orderType}">${idx}</a></li>
					</c:forEach>					
					
					<c:if test="${pageMaker.cri.page < pageMaker.totalPage}">
						<li><a
							href="blistCriteria${pageMaker.makeSearch(pageMaker.cri.page+1)}&orderType=${pageMaker.cri.orderType}">&raquo;</a></li>
							
						<li><a
										href="blistCriteria${pageMaker.makeSearch(pageMaker.totalPage)}&orderType=${pageMaker.cri.orderType}">
		...
		<script type="text/javascript">
			...
			$(document).ready(function() {
				 ...
				 $("#order_sel").click(function() {
						...
						self.location="blistCriteria${pageMaker.makeSearch(pageMaker.cri.page)}&orderType="+ea;
				 ...
				 $("#sel").change(function(){
					...
					//	self.location="/board/listCriteria?page=${pageMaker.cri.page}&perPageNum="+ea+"&change=${true}&revPerPageNum2=${pageMaker.cri.perPageNum}";
						self.location=encodeURI("blistCriteria?page=${pageMaker.cri.page}&perPageNum="+ea+"&searchType=${pageMaker.cri.searchType}&keyword=${pageMaker.cri.keyword}&orderType=${pageMaker.cri.orderType}");

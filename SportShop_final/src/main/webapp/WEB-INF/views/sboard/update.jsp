	...
	<div class="container">
		<div class="row">
			<form id="myForm" class="form-horizontal" method="post">
				...
				<div class="form-group">
					<label class="col-xs-2 control-label" for="id">작가</label>
					<div class="col-xs-10">
						<input readonly="readonly" class="form-control" value="${vo.id }" name="id"
							id="writer">
					</div>
				</div>
 ...
 */			
			...
			$(".btn-warning").on("click", function() {			
				...
				location.href= "/sboard/listCriteria?page=${cri.page}&perPageNum=${cri.perPageNum}&searchType=${cri.searchType}&keyword=${cri.keyword}&category=${cri.category}&orderType=${cri.orderType}";
				//location.href=encodeURI("/sboard/listCriteria?page=${cri.page}&perPageNum=${cri.perPageNum}&searchType=${cri.searchType}&keyword=${cri.keyword}");

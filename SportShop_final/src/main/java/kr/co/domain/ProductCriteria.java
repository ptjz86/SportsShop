...
public class ProductCriteria {
	...
	public ProductCriteria(int page, int perPageNum, String orderType, String category) {
		super();
		this.page = page;
	...
	public String toString() {
		return "ProductCriteria [page=" + page + ", perPageNum=" + perPageNum + ", orderType=" + orderType
				+ ", category=" + category + "]";
	}
